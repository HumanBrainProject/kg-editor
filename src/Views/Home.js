        ...
        <div className={classes.main}>
          <Scrollbars autoHide>
            ...
            {lastEditedDatasets && !!lastEditedDatasets.length && (
              <LastInstances title="Last 10 edited Datasets" list={lastEditedDatasets} />
            )}
            {lastViewedDatasets && !!lastViewedDatasets.length && (
              <LastInstances title="Last 10 viewed Datasets" list={lastViewedDatasets} />
            )}
            {lastBookmarkedDatasets && !!lastBookmarkedDatasets.length && (
              <LastInstances title="Last 10 bookmarked Datasets" list={lastBookmarkedDatasets} />
            )}
          </Scrollbars>
        </div>
