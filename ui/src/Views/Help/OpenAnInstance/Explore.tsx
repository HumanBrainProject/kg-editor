...
const Explore = () => (
  <div>
    ...
    <p>
      <img className="screenshot" src={`${window.rootPath}/assets/Help/OpenAnInstance/Explore/explore.png`} alt="explore"/>
    </p>
    ...
    <p>
      <img className="screenshot" src={`${window.rootPath}/assets/Help/OpenAnInstance/Explore/navigate.png`} alt="navigate" />
    </p>
    ...
    <p>
      <img className="screenshot" src={`${window.rootPath}/assets/Help/OpenAnInstance/Explore/configure.png`} alt="configure"/>
    </p>
    ...
    <p>
      <img className="screenshot" src={`${window.rootPath}/assets/Help/OpenAnInstance/Explore/capture.png`} alt="capture"/>
    </p>
  </div>
);
